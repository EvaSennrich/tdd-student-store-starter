  ...
  return (
    <div className="product-detail-cont">
      <div className="product-header">
        <h2 className="product-name">{` Product ${product[useParams().productId - 1].id} : ${product[useParams().productId - 1].name}`}</h2>
      </div>
      <div className="product-detail-card">
        <img src={product[useParams().productId - 1].image} alt={product[useParams().productId - 1].name + " image"} />
      </div>
